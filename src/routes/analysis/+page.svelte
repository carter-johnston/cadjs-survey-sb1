...
<div class="ms-5 me-5 mt-2">
    ...
    <p class="lead ms-3">
        Here is a list of surveys currently ready for export
    </p>
    <div class="list-group">
        {#each surveyList as survey, index}
            <div class="container border rounded p-2 m-2">
                <div class="d-flex p-2 ms-1">Name: {survey.surveyName}</div>
                <div class="d-flex p-2 ms-1">ID: {survey.id}</div>
                <div class="d-flex p-2 ms-1">
                    <div class="flex-fill">Author: {survey.surveyAuthor}</div>
                    <div class="flex-fill">
                ...
                <div class="d-flex p-2">
                    <button
                        ...
                        on:click={() => ExcelExport(index)}
                        >Download as Excel</button
                    >
                    <button
                        class="btn btn-outline-secondary me-2"
                        id="ExportPDF">Download as PDF</button
                    >
...
>>>>>>> a3abd81b0ee2ce8899e2aa9b5031cc81e1b7d61e
<!-- function Qslot(index){
