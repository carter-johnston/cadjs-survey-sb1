...
<div class="ms-5 me-5 mt-2">
  ...
  <div class="lead ms-3 mb-3">
    Here is a list of existing surveys. Select the <i>Activate</i> button on the
    survey that you wish to share. Once activated, that survey will only be available
    until the set expiration date or until you close it.
  </div>
  <div class="d-flex">
    <a href="/create"
      ><button class="btn btn-secondary ms-3 me-2">+ Create a survey</button></a
    >
